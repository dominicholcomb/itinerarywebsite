...
function saveToLocalStorage() {
  try {
    localStorage.setItem('lockDrawerStrokes', JSON.stringify(strokes));
  } catch (e) {
...
function loadFromLocalStorage() {
  try {
    const raw = localStorage.getItem('lockDrawerStrokes');
    if (raw) {
...
saveBtn.addEventListener('click', () => {
  ...
  downloadFile('lock-drawing-strokes.json', JSON.stringify(strokes), 'application/json');
});
